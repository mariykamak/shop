...
crud.add_product(db, "Apple MacBook", "ноутбуки", 47896.0)
crud.add_product(db, "Iphone 15", "телефони", 61999.0)

crud.add_client(db, "Тарас", "Шевченко", "sheva_taras@gmail.com")
crud.add_client(db, "Леся", "Українка", "ukrlesya@gmail.com")
